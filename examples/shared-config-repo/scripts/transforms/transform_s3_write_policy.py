...
# Example value that callers or README examples can reference. This will be
# populated from the environment `STACKSMITH_EXAMPLE_AWS_ACCOUNT` if present,
# otherwise we attempt to fetch the account id via boto3 when explicitly
# enabled with `STACKSMITH_FETCH_AWS_ACCOUNT_ID`.
EXAMPLE_AWS_ACCOUNT = (
