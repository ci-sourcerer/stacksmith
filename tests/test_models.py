...
class TestModuleSourceValidation:
    ...
    def test_tool_config_accepts_default_mapping_without_explicit_mappings(self):
        payload = _base_tool_config_payload()
        payload["module_mappings"] = {}
        payload["default_module_mapping"] = {
            "source": {
                "source": "git",
                "data": {
        ...
        assert config.default_module_mapping.providers == {"aws": "aws.default"}

    def test_tool_config_requires_explicit_or_default_mapping(self):
        payload = _base_tool_config_payload()
        payload["module_mappings"] = {}
